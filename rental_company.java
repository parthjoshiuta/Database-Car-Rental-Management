...
public class rental_company {//Dhanesh:import mysql-connector-java-5.1.32.jar 
	...
	String insertTableSQL = "INSERT INTO rental_company" 
	+ "(CNAME, OID, RC_ADDRESS) VALUES" 
	+ "(?,?,?)"; 
	...
	BufferedReader reader = new BufferedReader(new FileReader("/Users/parth/eclipse-workspace/DB-Project2/src/Rental_Company.csv")); 
