...
public class Model {//Dhanesh:import mysql-connector-java-5.1.32.jar 
	...
	String insertTableSQL = "INSERT INTO model" 
	+ "(MODELNAME, MODELYEAR) VALUES" 
	+ "(?,?)"; 
	...
	BufferedReader reader = new BufferedReader(new FileReader("/Users/parth/eclipse-workspace/DB-Project2/src/Model.csv")); 
