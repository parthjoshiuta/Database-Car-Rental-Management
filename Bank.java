...
public class Bank {//Dhanesh:import mysql-connector-java-5.1.32.jar 
	private static String JDBC_URL = "jdbc:mysql://localhost:3306/CarRental?useSSL=false"; 
	private static String USER = "root"; 
	private static String PASSWORD = "root"; 

	public static void main(String[] args) throws IOException, ClassNotFoundException,NumberFormatException, NoSuchElementException { 
	...
	String insertTableSQL = "INSERT INTO bank" 
	+ "(BANKNAME, OID, B_ADDRESS) VALUES" 
	+ "(?,?,?)"; 
	...
	BufferedReader reader = new BufferedReader(new FileReader("/Users/parth/eclipse-workspace/DB-Project2/src/Bank.csv")); 
